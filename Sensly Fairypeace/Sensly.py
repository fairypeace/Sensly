...
# Sensly Constants 
R0 = [138901.254881, 494.03150418, 5909888.91231]      # MQ2, MQ7, MQ135 R0 resistance (needed for PPM calculation)obtain with Sensly_Calibration (average of each columm).
                                            # Found by placing the Sensor in a clean air environment and running the calibration script
RSAir = [95, 27, 3.62]                     # Sensor RS/R0 ratio in clean air
